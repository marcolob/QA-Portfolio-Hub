...
## 6. Risks & Mitigations
- Risk: Unstable staging environment → Mitigation: schedule tests with dev ops & use replayable test data
- Risk: API rate limits → Mitigation: use mocked endpoints for heavy test iterations
